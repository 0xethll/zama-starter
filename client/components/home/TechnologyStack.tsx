...
export function TechnologyStack() {
  ...
  return (
    <section className="py-20 px-6 sm:px-8 bg-gradient-to-br from-blue-50/30 via-purple-50/20 to-pink-50/30 dark:from-blue-950/10 dark:via-purple-950/5 dark:to-pink-950/10">
